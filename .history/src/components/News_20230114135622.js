...
export class News extends Component {
  ...
  constructor(props){
    ...
    async updateNews(){  
      ...
      const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=1060124129e74d7baf8971b5939f7373&page=${this.state.page}&pageSize=${this.props.pageSize}`;
